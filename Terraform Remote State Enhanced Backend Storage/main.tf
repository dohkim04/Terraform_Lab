...
*/
## Lesson Title: [Section 47] Terraform State Backend Storage
...
resource "aws_instance" "web_server_2" {
  ami           = data.aws_ami.ubuntu.id
  instance_type = "t2.small" # "t2.small" # "t2.micro" #After enabling S3 bucket versioning, change from t2.micro -> t2.small then terraform apply
